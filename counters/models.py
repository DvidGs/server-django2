...
class Position(models.Model):
    ...
    REQUIRED_FIELDS = ['id', 'language_1', 'language_2', 'email', 'a1', 'a2', 'a3', 'a4', 'a5', 'a6']

    def __str__(self):
        return '%s %s %s %s %s %s %s %s %s %s' % (self.id, self.language_1, self.language_2, self.email, self.a1, self.a2, self.a3, self.a4, self.a5, self.a6)
